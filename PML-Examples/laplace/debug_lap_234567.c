...
printf("\n=====3========================---------\n");
    for (_x0_234567 = (_i_start-1), _y0_234567 =0; _x0_234567 < _i_start; _x0_234567 +=_i_step, _y0_234567 ++) {
        for (_x1_234567 = _j_start, _y1_234567 =0; _x1_234567 < _j_stop; _x1_234567 +=_j_step, _y1_234567 ++) {
printf("%8.1f, ", _tp_A_234567[_y0_234567 * ((_j_stop - _j_start - 1) / _j_step + 1) + _y1_234567]);
        }
printf("\n");
    }
printf("\nread _tp_name (%s), _tp_size (%d)\n", _tp_name, _tp_size);
...
printf("\n=====4========================---------\n");
    for (_x0_234567 = _i_start, _y0_234567 =0; _x0_234567 < _i_stop; _x0_234567 +=_i_step, _y0_234567 ++) {
        for (_x1_234567 = (_j_start-1), _y1_234567 =0; _x1_234567 < _j_start; _x1_234567 +=_j_step, _y1_234567 ++) {
printf("%8.1f, ", _tp_A_234567[_y0_234567 * ((_j_start - (_j_start-1) - 1) / _j_step + 1) + _y1_234567]);
        }
printf("\n");
    }
printf("\nread _tp_name (%s), _tp_size (%d)\n", _tp_name, _tp_size);
...
/* <target index ="i" order ="1" limits="(1,rdim+1,1)" chunk ="2"> */
for (i = _i_start; i < _i_stop; i +=_i_step) 
/* </target> */
 
         {
             
/* <target index ="j" order ="1" limits="(1,DIM+1,1)" chunk ="2"> */
...
printf("###### worker: (%8.1f), (%8.1f), (%8.1f), (%8.1f) => (%8.1f) ======\n", A[i+1][j], A[i-1][j], A[i][j+1], A[i][j-1], A[i][j]);
