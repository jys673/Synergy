...
_constructor = _open_space("constructor", 0, "123456");
    ...
    _tp_size = _read_data(_constructor, _tp_name, (char *)_tp_A_123456, _tp_size);
    if (_tp_size < 0) exit(-1);
    for (_x0_123456 = 0; _x0_123456 < (N); _x0_123456 +=1) {
        for (_x1_123456 = 0; _x1_123456 < (N); _x1_123456 +=1) {

            A[_x0_123456][_x1_123456] = _tp_A_123456[_x0_123456 * (N) + _x1_123456];
        }
    }
    ...
    for (_x0_123456 = 0; _x0_123456 < (N); _x0_123456 +=1) {
        for (_x1_123456 = _k_start, _y1_123456 =0; _x1_123456 < _k_stop; _x1_123456 +=_k_step, _y1_123456 ++) {
            ...
            A[_x0_123456][_x1_123456] = _tp_A_123456[_x0_123456 * ((_k_stop - _k_start - 1) / _k_step + 1) + _y1_123456];
        }
    }
    ...
    for (_x0_123456 = _i_start, _y0_123456 =0; _x0_123456 < _i_stop; _x0_123456 +=_i_step, _y0_123456 ++) {
        for (_x1_123456 = _k_stop, _y1_123456 =0; _x1_123456 < (_k_stop-1); _x1_123456 +=_k_step, _y1_123456 ++) {
            ...
            A[_x0_123456][_x1_123456] = _tp_A_123456[_y0_123456 * (((_k_stop-1) - _k_stop - 1) / _k_step + 1) + _y1_123456];
        }
    }
...
while (1)
{
    ...
    /* <token action="GET" idxset="(i)(k)"/> */
    sprintf(_tp_name, "token#%s", "123456");
    _tp_size = 0;
    _tp_size = _get_token(_distributor, _tp_name, (char *)_tp_token, _tp_size);
    if (_tp_size < 0) exit(-1);
    if (_tp_token[0] == '!') break;
    sscanf(_tp_token, "%d@(i:%d~%d,%d)(k:%d~%d,%d)", &_tokens, &_i_start, &_i_stop, &_i_step, &_k_start, &_k_stop, &_k_step);
    ...
    for (_x0_123456 = _i_start, _y0_123456 =0; _x0_123456 < _i_stop; _x0_123456 +=_i_step, _y0_123456 ++) {
        for (_x1_123456 = 0; _x1_123456 < (N); _x1_123456 +=1) {
            ...
            B[_x0_123456][_x1_123456] = _tp_B_123456[_y0_123456 * (N) + _x1_123456];
        }
    }
    ...
    _tp_B_123456 = (double *)malloc(_tp_size);
    _tp_size = _read_data(_constructor, _tp_name, (char *)_tp_B_123456, _tp_size);
    if (_tp_size < 0) exit(-1);
    for (_x0_123456 = 0; _x0_123456 < (N); _x0_123456 +=1) {
        for (_x1_123456 = (_k_start-1), _y1_123456 =0; _x1_123456 < (_k_stop-1); _x1_123456 +=_k_step, _y1_123456 ++) {

            B[_x0_123456][_x1_123456] = _tp_B_123456[_x0_123456 * (((_k_stop-1) - (_k_start-1) - 1) / _k_step + 1) + _y1_123456];
        }
    }
    ...
    for (_x0_123456 = (_i_start-1), _y0_123456 =0; _x0_123456 < _i_start; _x0_123456 +=_i_step, _y0_123456 ++) {
        for (_x1_123456 = _k_start, _y1_123456 =0; _x1_123456 < _k_stop; _x1_123456 +=_k_step, _y1_123456 ++) {
            ...
            B[_x0_123456][_x1_123456] = _tp_B_123456[_y0_123456 * ((_k_stop - _k_start - 1) / _k_step + 1) + _y1_123456];
        }
    }
...
/* <target index ="i" order ="1" limits="(0,N,1)" chunk ="100"> */
for (i = _i_start; i < _i_stop; i +=_i_step) 
/* </target> */
 
    {
         
/* <target index ="k" order ="1" limits="(0,N,1)" jump  ="20"> */
for (k = _k_start; k < _k_stop; k +=_k_step) 
/* </target> */
    ...
    for (_x0_123456 = 0; _x0_123456 < (N); _x0_123456 +=1) {
        for (_x1_123456 = 0; _x1_123456 < (N); _x1_123456 +=1) {
            ...
            _tp_C_123456[_x0_123456 * (N) + _x1_123456] = C[_x0_123456][_x1_123456];
        }
    }
    ...
    _status  = _send_data(_distributor, _tp_name, (char *)_tp_C_123456, _tp_size);
    if (_status < 0) exit(-1);
    free(_tp_C_123456);
    ...
    for (_x0_123456 = 0; _x0_123456 < (N); _x0_123456 +=1) {
        for (_x1_123456 = (_k_start-1), _y1_123456 =0; _x1_123456 < (_k_stop-1); _x1_123456 +=_k_step, _y1_123456 ++) {
            ...
            _tp_C_123456[_x0_123456 * (((_k_stop-1) - (_k_start-1) - 1) / _k_step + 1) + _y1_123456] = C[_x0_123456][_x1_123456];
        }
    }
    ...
    for (_x0_123456 = _i_stop, _y0_123456 =0; _x0_123456 < (_i_stop-1); _x0_123456 +=_i_step, _y0_123456 ++) {
        for (_x1_123456 = (_k_start-1), _y1_123456 =0; _x1_123456 < _k_start; _x1_123456 +=_k_step, _y1_123456 ++) {
            ...
            _tp_C_123456[_y0_123456 * ((_k_start - (_k_start-1) - 1) / _k_step + 1) + _y1_123456] = C[_x0_123456][_x1_123456];
        }
    }
