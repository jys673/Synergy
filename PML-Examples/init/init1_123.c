...
while (1)
{
    ...
    sprintf(_tp_name, "double(%d)(%d):A#%s[%d~%d,%d][%d~%d,%d]@%d", (N), (N), "123", _i_start, _i_stop, 1, 0, (N), 1, sizeof(double));
    _tp_size = (((_i_stop - _i_start - 1) / 1 + 1) * (N)) * sizeof(double);
    ...
    for (_x0_123 = _i_start, _y0_123 =0; _x0_123 < _i_stop; _x0_123 +=1, _y0_123 ++) {
        for (_x1_123 = 0; _x1_123 < (N); _x1_123 +=1) {
            ...
            A[_x0_123][_x1_123] = _tp_A_123[_y0_123 * (N) + _x1_123];
        }
    }
...
/* </target> */
    ...
    for (_x0_123 = _i_start, _y0_123 =0; _x0_123 < _i_stop; _x0_123 +=1, _y0_123 ++) {
        for (_x1_123 = 0; _x1_123 < (N); _x1_123 +=1) {
            ...
            _tp_A_123[_y0_123 * (N) + _x1_123] = A[_x0_123][_x1_123];
        }
    }
